...
HD_PWD='c:/users/sean/documents/ugv_projects/uartlite/uartlite.tmp/pololusteppera_v1_0_project/PololuStepperA_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PololuStepperA_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PololuStepperA_v1_0.tcl
